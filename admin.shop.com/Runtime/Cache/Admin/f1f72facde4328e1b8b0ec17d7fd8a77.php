        ...
        <table cellpadding="3" cellspacing="1">
            ...
            <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                    <td width="30px"><?php echo ($row["id"]); ?><input type="checkbox" class="ids" name="id[]" value="<?php echo ($row["id"]); ?>"/></td>
                     <td class="first-cell"><?php echo ($row["name"]); ?></td><td align="center"><?php echo ($row["short_name"]); ?></td><td align="center"><?php echo ($row["sn"]); ?></td><td align="center"><?php echo ($row["goods_category_id"]); ?></td><td align="center"><?php echo ($row["brand_id"]); ?></td><td align="center"><?php echo ($row["supplier_id"]); ?></td><td align="center"><?php echo ($row["shop_price"]); ?></td><td align="center"><?php echo ($row["market_price"]); ?></td><td align="center"><?php echo ($row["logo"]); ?></td><td align="center"><?php echo ($row["stock"]); ?></td><td align="center"><?php echo ($row["goods_status"]); ?></td><td align="center"><a class='ajax-get' href="<?php echo U('changeStatus',array('id'=>$row['id'],'status'=>1-$row['status']));?>"><img src="http://admin.shop.com:8080/Public/Admin/images/<?php echo ($row["status"]); ?>.gif"/></a></td>                    <td align="center">
